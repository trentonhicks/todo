...
{
    public class SendInvitationToClientWhenInvitationIsAccepted : INotificationHandler<InvitationAccepted>
    {
        private readonly IHubContext<NotificationHub> _hubContext;

        public SendInvitationToClientWhenInvitationIsAccepted(IHubContext<NotificationHub> hubContext)
        {
