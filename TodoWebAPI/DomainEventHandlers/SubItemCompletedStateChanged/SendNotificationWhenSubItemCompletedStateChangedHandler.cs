...
namespace TodoWebAPI.DomainEventHandlers
{
    public class SendNotificationWhenSubItemCompletedStateChangedHandler : INotificationHandler<SubItemCompletedStateChanged>
    {
        ...
        public SendNotificationWhenSubItemCompletedStateChangedHandler(IHubContext<NotificationHub> hubContext, ITodoListItemRepository todoListItem, ITodoListRepository todoList)
        {
